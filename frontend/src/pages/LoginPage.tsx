...
import { FileSignature, ArrowLeft, Lock, Mail } from 'lucide-react';
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-blue-600 to-indigo-600 p-12 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-white max-w-md">
          ...
          <p className="text-xl text-blue-100 mb-8">
            Sign in to access your contracts, proposals, and collaborate with your team.
          </p>
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-white text-gray-500">New to ContractFlow?</span>
                </div>
              </div>
